...
public class DIController {
		...
		public String myCal(Model model) {
			...
			/*
			 ...
			 ※webapp 하위의 resources 디렉토리는 이미지나 js파일 등
			...
			/*
			 XML 설정파일에서 생성한 Bean을 getBean()을 통해 주입받아
			 참조변수에 할당한다. new 연산자를 통해 생성한 것과 동일하지만
			 외부 설정파일에서 미리 생성한 것을 주입(Injection) 받은 것임에
			 유의할것.
			 */
			CalculatorDTO myCal = 
